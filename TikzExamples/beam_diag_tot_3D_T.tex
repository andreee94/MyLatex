...
\begin{tikzpicture}[coords]
	...
	\def\M {{5.6188,	5.6188,	-0.63865,	-0.63865,	-0.70635,	-0.7059,	-3.932,	-3.932}};
	

	\def\Myz {{1.31705,	1.31705,	0.52955,	0.52955,	-0.25795,	-0.25795,	-1.04545,	-1.04545}};
	
	
	\def \Mxy {{0.7655,	0.7655,	0,	0,	0,	0,	-0.7655,	-0.7655}};
...
% 	\point{e}{\b+\b}{0};
	...
	\pgfmathsetmacro{\esx}{\M[7] / \k + \Myz[7] / \k}
 	...
 	\dinternalforces{xz}{a}{b}{\adx}{\bsx}[0][cyan];
  	\dinternalforces{xz}{b}{c}{\bdx}{\csx}[0][cyan];
  	\dinternalforces{xz}{c}{d}{\cdx}{\dsx}[0][cyan];
 	\dinternalforces{xz}{d}{e}{\ddx}{\esx}[0][cyan];
...
%  	\dinternalforces{xz}{d}{e}{\ddx}{\esx}[0][brown];
	...
	\pgfmathsetmacro{\esx}{\Mxy[7] / \k}
 	...
 	\dinternalforces{yx}{a}{b}{\adx}{\bsx}[0][cyan];
  	\dinternalforces{yx}{b}{c}{\bdx}{\csx}[0][cyan];
  	\dinternalforces{yx}{c}{d}{\cdx}{\dsx}[0][cyan];
 	\dinternalforces{yx}{d}{e}{\ddx}{\esx}[0][cyan];
