...
% 	\point{e}{\b+\b}{0};
	...
	\begin{scope}[canvas is zy plane at x=0]
			%\draw[even odd rule, pattern = north east lines]
			\draw[even odd rule,  fill=brown]
											(a) circle (0.7)
					   						(a) circle (1.15);
			\draw[even odd rule,  pattern = north east lines]
											(a) circle (0.7)
	...
	\dload{4}{a}[90][0][2][0][$M_t$][xshift = 8,yshift=-3]; 
	%\dnotation{1}{a}{$M_t$}[right, xshift=2]; 
	
	\dload{2}{a}[-90][0][1.9][0][$N$][xshift = -8,yshift=3]; 
	
	\dload{4}{a}[0][0][2][0][$M_{xy}$][xshift = 0,yshift=8]; 
	
	\dload{4}{a}[-90][90][2][0][$M_{zy}$][xshift=12,yshift=3]; 
